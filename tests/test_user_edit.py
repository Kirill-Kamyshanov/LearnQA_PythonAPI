...
class TestUserEdit(BaseCase):
    def test_edit_just_created_user(self):
        ...
        response1 = requests.post('https://playground.learnqa.ru/api/user/', json=register_data)
        ...
        response2 = requests.post('https://playground.learnqa.ru/api/user/login', json=login_data)
