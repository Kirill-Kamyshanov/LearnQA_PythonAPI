...
class TestUserRegister(BaseCase):
    ...
    def test_create_user_successfully(self):
        ...
        with allure.step('Create user successfully'):
    ...
    def test_create_user_with_existing_email(self):
        ...
        with allure.step('Trying to create user with existing email'):
            response = MyRequests.post('/user/', data=data)
    ...
    def test_create_user_without_at_symbol(self):
        ...
        with allure.step('Trying to create user with incorrect email without "@" symbol'):
            data = self.prepare_registration_data()
    ...
    def test_create_user_without_any_necessary_field(self, field_to_remove):
        ...
        with allure.step('Trying to create user without necessary field'):
            data = self.prepare_registration_data()
    ...
    def test_create_user_with_short_name(self):
        ...
        with allure.step('Trying to create user with too short name'):
            data = self.prepare_registration_data()
    ...
    def test_create_user_with_too_long_name(self):
        ...
        with allure.step('Trying to create user with too long name'):
            data = self.prepare_registration_data()
